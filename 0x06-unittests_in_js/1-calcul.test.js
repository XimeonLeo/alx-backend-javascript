...
describe('calculateNumber', () => {
  describe('type == "SUM"', () => {
    it('equal positive numbers', () => {
      assert.strictEqual(calculateNumber('SUM', 8.0, 8.0), 16);
    });

    it('equal positive numbers (alternate)', () => {
      assert.strictEqual(calculateNumber('SUM', 5.3, 1.8), 7);
    });
  ...
  describe('type == "SUBTRACT"', () => {
    ...
    it('equal negative numbers', () => {
      assert.strictEqual(calculateNumber('SUBTRACT', -7.0, -7.0), 0);
    });
